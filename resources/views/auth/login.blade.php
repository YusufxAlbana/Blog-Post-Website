...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md relative z-10 fade-in">
        ...
        <div class="text-center mb-8">
            ...
            <p style="color: #9CA3AF;">Masuk ke akun Anda untuk melanjutkan</p>
        </div>
        ...
        <div class="auth-card rounded-2xl p-8">
            <!-- Session Status -->
            @if (session('status'))
                <div class="mb-4 p-4 rounded-lg" style="background: rgba(34, 197, 94, 0.1); border: 1px solid rgba(34, 197, 94, 0.3); color: #4ade80;">
                    {{ session('status') }}
                </div>
            @endif
                ...
                <div class="flex items-center justify-between mb-6">
                    <label class="inline-flex items-center cursor-pointer">
                        <input 
                            ...
                            class="rounded"
                        >
                        <span class="ml-2 text-sm" style="color: #9CA3AF;">Ingat saya</span>
                    </label>

                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-sm transition-colors" style="color: #8A2BE2;" onmouseover="this.style.color='#9D4EDD'" onmouseout="this.style.color='#8A2BE2'">
                            Lupa password?
                        </a>
                    @endif
                </div>
