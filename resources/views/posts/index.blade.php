        ...
        <div class="sticky top-0 z-40" style="background: rgba(13, 13, 13, 0.95); backdrop-filter: blur(10px); border-bottom: 1px solid rgba(138, 43, 226, 0.2);">
            <div class="flex gap-6 px-6">
                ...
                <div class="w-80 flex-shrink-0 py-3 flex items-center gap-3">
                    ...
                    <!-- Info Button -->
                    <x-info-button id="Blog" title="About Blog" modal-title="Blog" subtitle="Discover & Share">
                        <div>
                            <h3 class="text-xl font-bold mb-3" style="color: #E0E0E0;">Tentang Halaman Blog</h3>
                            <p style="color: #9CA3AF; line-height: 1.6;">
                                Halaman Blog adalah pusat dari semua konten di BLOGMOUS. Di sini Anda dapat menemukan postingan terbaru dari semua user atau hanya dari user yang Anda follow.
                            </p>
                        </div>

                        <div>
                            <h3 class="text-xl font-bold mb-3" style="color: #E0E0E0;">Fitur Blog</h3>
                            <div class="space-y-3">
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        <h4 class="font-semibold mb-1" style="color: #E0E0E0;">For You & Following Tabs</h4>
                                        <p class="text-sm" style="color: #9CA3AF;">Switch antara semua posts atau hanya dari user yang Anda follow</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        <h4 class="font-semibold mb-1" style="color: #E0E0E0;">Search Posts</h4>
                                ...
                                <div class="flex gap-3">
                                    <div class="flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center" style="background: rgba(138, 43, 226, 0.2);">
                                        <svg class="w-4 h-4" style="color: #8A2BE2;" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"></path>
                                        </svg>
                                    </div>
                                    <div>
                                        <h4 class="font-semibold mb-1" style="color: #E0E0E0;">Most Liked Posts</h4>
                                        <p class="text-sm" style="color: #9CA3AF;">Lihat ranking posts dengan like terbanyak</p>
                                    </div>
                                </div>
                            </div>
                        </div>
